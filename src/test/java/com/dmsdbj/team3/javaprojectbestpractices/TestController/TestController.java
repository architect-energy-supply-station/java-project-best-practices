package com.dmsdbj.team3.javaprojectbestpractices.TestController;
...
public class TestController extends AbstractTestNGSpringContextTests {
    ...
    public void testSaveUser() throws Exception {
        ...
        this.mvc.perform(post("/user/save").contentType(MediaType.APPLICATION_JSON).content(JSON.toJSONString(user)))
                .andDo(print())
                .andExpect(status().isOk());
    }
